module Codebreaker_cases
    ...
    def self.data
      [
        ...
        %w[1234 1234 ++++], %w[4444 4444 ++++], %w[3331 3332 +++],
        %w[1113 1112 +++], %w[1234 1266 ++], %w[1234 6634 ++],
        %w[1234 1654 ++], %w[1234 1555 +], %w[1234 4321 ----],
        %w[5432 2345 ----], %w[1234 2143 ----], %w[1221 2112 ----],
        %w[5432 2541 ---], %w[1145 6514 ---], %w[1244 4156 --],
        %w[1221 2332 --], %w[2244 4526 --], %w[5556 1115 -],
        %w[1234 6653 -], %w[3331 1253 --], %w[1243 1234 ++--],
        %w[4111 4444 +], %w[1532 5132 ++--], %w[3444 4334 +--],
        %w[1113 2155 +], %w[2245 4125 +--], %w[4611 1466 ---],
        ['3331', '3332', '+++' ],
        ['1113', '1112', '+++' ],
        ['1312', '1212', '+++' ],
        ['1234', '1235', '+++' ],
